...
public class ItemAndItemPic {
	...
	public String toString() {
		return "ItemAndItemPic [categoryName=" + categoryName + ", memberNo=" + memberNo + ", itemTitle=" + itemTitle
				+ ", itemContent=" + itemContent + ", itemPrice=" + itemPrice + ", itemState=" + itemState
				+ ", itemDate=" + itemDate + ", itemNo=" + itemNo + ", itemPicNameOne=" + itemPicNameOne
